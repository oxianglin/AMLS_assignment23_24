...
class Net(nn.Module): #Adopt from memdmnist sample code
...
class data_set(data.Dataset): #Adopt from medmnist site-package
    data_file = ''
    ...
    def search_data(self):
        dir = os.path.dirname(__file__) #<This file directory> which is <upper directories/amls/A>
        ds = dir.split(os.sep)
...
class Pathmnist(): #Adopt from medmnist sample code
